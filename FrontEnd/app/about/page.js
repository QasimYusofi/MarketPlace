      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            آوینا با هدف ایجاد تحول در تجارت الکترونیک ایران در سال ۱۴۰۴ توسط
            آقایان{" "}
            <b className="text-blue-500">فرتاش، یوسفی، رضایی و کربلایی</b> تأسیس
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-blue-100 leading-relaxed mb-4">
                آوینا با این باور متولد شد که هر افغانستانی باید بتواند به راحتی
                و با اطمینان خرید و فروش آنلاین انجام دهد. ما با تیمی جوان و
